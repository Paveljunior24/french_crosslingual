...
public class WekaCvEvaluation implements Evaluation {
	...
	private String evaluationFileName = "combined_classification_results.txt";
	
	public WekaCvEvaluation(String dataset, File f) {
